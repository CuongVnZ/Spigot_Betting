...
public class RSerializer {
    ...
    public static Location deserializeLocation(String s) {
        Location def = BettingPlugin.plugin.getServer().getWorlds().get(0).getSpawnLocation();
        if (s.length() == 0)
            return def;
        ...
        try {
            ...
            World w = BettingPlugin.plugin.getServer().getWorld(data[5]);
            if (w == null) {
                BettingPlugin.plugin.getServer().getWorlds().get(0).getSpawnLocation();
            }
