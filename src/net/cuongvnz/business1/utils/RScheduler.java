...
public class RScheduler {
     ...
     * @return
     */
    public static int schedule(JavaPlugin plugin, Runnable r, int runInTicks) {
        return plugin.getServer().getScheduler().scheduleSyncDelayedTask(plugin, r, runInTicks);
    }
